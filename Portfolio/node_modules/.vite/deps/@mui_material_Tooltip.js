...
var Global = withEmotionCache(function(props, cache2) {
  ...
  var serialized = serializeStyles([styles3], void 0, React69.useContext(ThemeContext));
  if (!isBrowser2) {
    var _ref;
...
function ThemeProvider4(_ref) {
  ...
  return (0, import_jsx_runtime55.jsx)(ThemeProvider_default2, _extends({}, props, {
...
true ? ThemeProvider4.propTypes = {
   ...
   * A theme object. You can provide a function to extend the outer theme.
   */
  theme: import_prop_types50.default.oneOfType([import_prop_types50.default.object, import_prop_types50.default.func]).isRequired
} : void 0;
...
var Popper3 = React95.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
...
var Tooltip = React96.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children2 = React96.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime57.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme5();
  ...
  return (0, import_jsx_runtime58.jsxs)(React96.Fragment, {
    children: [React96.cloneElement(children2, childrenProps), (0, import_jsx_runtime57.jsx)(PopperComponent, _extends({
